 ...
 */
export function plural(count: Nullable<number>, forms: PluralForms, opts: PluralOptions = {}): string {
...
export function compare(a: Nullable<string>, b: Nullable<string>, opts: CollatorOptions = {}): number {
  const { tag, intl } = resolve(opts);
