...
هر پروژه یک زبان دارد؛ این پروژه فارسی (`fa`)، راست‌به‌چپ (`rtl`) و با تقویم جلالی است. هیچ‌جای اپ نباید خودش تصمیم بگیرد که «الان RTL هستیم یا نه»؛ همه از پروفایل لوکال می‌خوانند.
